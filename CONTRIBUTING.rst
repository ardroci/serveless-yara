...
Welcome to ``serveless-yara`` contributor's guide.
...
If you experience bugs or general issues with ``serveless-yara``, please have a look
...
You can help improve ``serveless-yara`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``serveless-yara`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``serveless-yara``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n serveless-yara python=3 six virtualenv pytest pytest-cov
    conda activate serveless-yara
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/serveless-yara.git
    cd serveless-yara
...
#. Install |pre-commit|_::
   ...
   ``serveless-yara`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/serveless-yara
.. _issue tracker: https://github.com/<USERNAME>/serveless-yara/issues
.. <-- end -->
